...
class VsLicenseController extends Controller
{
    protected $backend;
    ...
    /**
     * Show VS license application form
     * GET /vs-license
     */
    public function index(Request $request)
    {
        ...
        try {
            ...
            $draftResponse = $this->authorizedRequest()
                ->get($this->backend . '/api/vs-license/check-draft', ['uid' => $uid]);
            ...
            $allotmentResponse = $this->authorizedRequest()
                ->get($this->backend . '/api/vs-license/allotment-details', ['uid' => $uid]);
            ...
            return view('housingTheme.license-application.vs-license', [
                'appType' => 'VSL',
                'districts' => $districts,
                'payBands' => $payBands,
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $response = $builder->post($this->backend . '/api/vs-license/store');
            ...
            Log::error('VS License Store Error', [
                'error' => $e->getMessage(),
                'trace' => $e->getTraceAsString()
            ]);
