            ...
            <div class="cms-card">
                <div class="cms-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3><i class="fa fa-calendar me-2"></i> Add Possession Details</h3>
                            <p class="mb-0">Enter possession date for the application</p>
                        </div>
                ...
                <div class="cms-body">
                    <form action="{{ route('application-status-check.store-possession', ['id' => $id, 'status' => $status]) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" 
                                           class="form-control datepicker @error('add_possession_date') is-invalid @enderror" 
                                           id="add_possession_date" 
                                           name="add_possession_date" 
                                           placeholder="Enter Possession Date" 
                                           value="{{ old('add_possession_date') }}"
                                           required>
                                    <label for="add_possession_date">Enter Possession Date</label>
                                    @error('add_possession_date')
