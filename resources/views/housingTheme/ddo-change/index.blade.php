            ...
            empty($current_ddo['ddo_code'])
                                        ...
                                        @else
                                            <div class="alert alert-warning">
                                                ...
                                                <strong>Note:</strong> Your DDO code is not found in the Housing Department records. Please contact the department for
                                                updation before proceeding.<br>
                                                <span class="text-danger fw-bold">You can not proceed further without departmental approval.</span>
                                            </div>
                                            <div class="d-flex gap-2">
                                                <button type="submit" class="btn bg-primary btn-sm px-5 rounded-pill text-white fw-bolder" disabled>
                                                    Save
                                                </button>
                                            </div>
                                        @endif
