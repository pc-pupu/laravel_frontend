        ...
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select" id="application_type" name="application_type" required>
                    ...
                    <option value="VS" {{ (isset($application->application_no) && strpos($application->application_no, 'VS') === 0) || old('application_type') == 'VS' ? 'selected' : '' }}>Floor Shifting</option>
                    <option value="CS" {{ (isset($application->application_no) && strpos($application->application_no, 'CS') === 0) || old('application_type') == 'CS' ? 'selected' : '' }}>Category Shifting</option>
                </select>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="application_date" name="application_date" 
                    placeholder="DD/MM/YYYY" value="{{ $application->date_of_application ?? old('application_date') }}" required autocomplete="off" readonly>
...
<div class="form-section">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="applicant_name" name="applicant_name" 
                    placeholder="Applicant Name" value="{{ $application->applicant_name ?? old('applicant_name') }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="applicant_father_name" name="applicant_father_name" 
                    placeholder="Father/Husband Name" value="{{ $application->guardian_name ?? old('applicant_father_name', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_street" name="permanent_street" 
                    placeholder="Address" value="{{ $application->permanent_street ?? old('permanent_street', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_city_town_village" name="permanent_city_town_village" 
                    placeholder="City/Town/Village" value="{{ $application->permanent_city_town_village ?? old('permanent_city_town_village', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_post_office" name="permanent_post_office" 
                    placeholder="Post Office" value="{{ $application->permanent_post_office ?? old('permanent_post_office', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="permanent_pincode" name="permanent_pincode" 
                    placeholder="Pincode" maxlength="6" value="{{ $application->permanent_pincode ?? old('permanent_pincode', '700001') }}">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_street" name="present_street" 
                    placeholder="Address" value="{{ $application->present_street ?? old('present_street', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_city_town_village" name="present_city_town_village" 
                    placeholder="City/Town/Village" value="{{ $application->present_city_town_village ?? old('present_city_town_village', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_post_office" name="present_post_office" 
                    placeholder="Post Office" value="{{ $application->present_post_office ?? old('present_post_office', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="present_pincode" name="present_pincode" 
                    placeholder="Pincode" maxlength="6" value="{{ $application->present_pincode ?? old('present_pincode', '700001') }}">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="mobile" name="mobile" 
                    placeholder="Mobile No" maxlength="10" value="{{ $application->mobile_no ?? old('mobile', '9999999999') }}">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="email" name="email" 
                    placeholder="Email ID" value="{{ $application->email ?? old('email') }}" oninput="this.value=this.value.toLowerCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="dob" name="dob" 
                    placeholder="DD/MM/YYYY" value="{{ $application->date_of_birth ?? old('dob', '01/01/1900') }}" autocomplete="off" readonly>
            ...
            <div class="form-group">
                ...
                <div class="d-flex">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="gender_m" value="M" required {{ ($application->gender ?? old('gender', 'M')) == 'M' ? 'checked' : '' }}>
                        <label class="form-check-label" for="gender_m">Male</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="gender_f" value="F" required {{ ($application->gender ?? old('gender')) == 'F' ? 'checked' : '' }}>
    ...
    <input type="hidden" name="housing_applicant_id" id="housing_applicant_id" value="{{ $application->housing_applicant_id ?? '' }}">
    <input type="hidden" name="housing_hrms_id" id="housing_hrms_id" value="{{ $application->hrms_id ?? '' }}">
    <input type="hidden" name="housing_hidden_uid" id="housing_hidden_uid" value="{{ $application->uid ?? '' }}">
    <input type="hidden" name="housing_hidden_uid_or_draft_id" value="{{ $application->uid ?? '' }}">
</div>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="hrms_id" name="hrms_id" 
                    placeholder="Employee HRMS ID" maxlength="10" value="{{ $application->hrms_id ?? old('hrms_id') }}" 
                    {{ !empty($application->hrms_id) ? 'readonly' : '' }}>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_designation" name="app_designation" 
                    placeholder="Designation" value="{{ $application->applicant_designation ?? old('app_designation', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="d-flex">
                    @php
                        $payBandType = 'old';
                        if (isset($application->pay_band_id) && $application->pay_band_id <= 5) {
                            $payBandType = 'new';
                        }
                    @endphp
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="pay_type_new" id="pay_type_new_new" value="new" {{ ($payBandType ?? old('pay_type_new', 'old')) == 'new' ? 'checked' : '' }}>
                        <label class="form-check-label" for="pay_type_new_new">New</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="pay_type_new" id="pay_type_new_old" value="old" {{ ($payBandType ?? old('pay_type_new', 'old')) == 'old' ? 'checked' : '' }}>
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="pay_in" name="pay_in" 
                    placeholder="Basic Pay" value="{{ $application->pay_in_the_pay_band ?? old('pay_in', '1') }}">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_posting_place" name="app_posting_place" 
                    placeholder="Place of Posting" value="{{ $application->applicant_posting_place ?? old('app_posting_place', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_headquarter" name="app_headquarter" 
                    placeholder="Headquarter" value="{{ $application->applicant_headquarter ?? old('app_headquarter', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="doj" name="doj" 
                    placeholder="DD/MM/YYYY" value="{{ $application->date_of_joining ?? old('doj', '01/01/1900') }}" autocomplete="off" readonly>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="dor" name="dor" 
                    placeholder="DD/MM/YYYY" value="{{ $application->date_of_retirement ?? old('dor') }}" required autocomplete="off" readonly>
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_name" name="office_name" 
                    placeholder="Name of the Office" value="{{ $application->office_name ?? old('office_name', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_street" name="office_street" 
                    placeholder="Address" value="{{ $application->office_street ?? old('office_street', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_city" name="office_city" 
                    placeholder="City/Town/Village" value="{{ $application->office_city_town_village ?? old('office_city', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_post_office" name="office_post_office" 
                    placeholder="Post Office" value="{{ $application->office_post_office ?? old('office_post_office', 'NA') }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="office_pincode" name="office_pincode" 
                    placeholder="Pincode" maxlength="6" value="{{ $application->office_pin_code ?? old('office_pincode', '700001') }}">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="office_phone_no" name="office_phone_no" 
                    placeholder="Phone No" maxlength="15" value="{{ $application->office_phone_no ?? old('office_phone_no', '033-22222222') }}">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="possession_date" name="possession_date" 
                    placeholder="DD/MM/YYYY" value="{{ $application->possession_date ?? old('possession_date') }}" required readonly>
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="license_no" name="license_no" 
                    placeholder="License Number" value="{{ ($application->license_no ?? old('license_no', 'NA')) }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="physical_application_no" name="physical_application_no" 
                    placeholder="Physical Application Number" value="{{ $application->physical_application_no ?? old('physical_application_no', 'NA') }}">
