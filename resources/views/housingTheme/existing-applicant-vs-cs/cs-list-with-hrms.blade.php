...
@section('title', 'CS List (With HRMS)')
@section('page-header', 'Existing Applicant\'s List for Category Shifting (with HRMS ID)')
        ...
        <div class="col-md-12">
            <div class="cms-card">
                <div class="search-filter-box">
                    <form method="GET" action="{{ route('existing-applicant-vs-cs.cs-list-with-hrms') }}" id="filterForm">
                        <div class="row">
                            <div class="col-md-4">
