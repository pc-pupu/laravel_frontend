...
@section('title', 'CS List (Without HRMS)')
@section('page-header', 'Existing Applicant\'s List for Category Shifting (without HRMS ID)')
        ...
        <div class="col-md-12">
            <div class="cms-card">
                <div class="search-filter-box">
                    <form method="GET" action="{{ route('existing-applicant-vs-cs.cs-list-without-hrms') }}" id="filterForm">
                        <div class="row">
                            <div class="col-md-4">
