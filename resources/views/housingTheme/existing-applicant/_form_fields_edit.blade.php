@php
    $applicant = $applicant ?? [];
    $dob = $applicant['dob'] ?? ($applicant['date_of_birth'] ?? '');
    $doj = $applicant['doj'] ?? ($applicant['date_of_joining'] ?? '');
    $dor = $applicant['dor'] ?? ($applicant['date_of_retirement'] ?? '');
    $doa = $applicant['doa'] ?? ($applicant['date_of_application'] ?? '');
    $payBandType = 'new';
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="applicant_name" name="applicant_name" 
                    value="{{ $applicant['applicant_name'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="applicant_father_name" name="applicant_father_name" 
                    value="{{ $applicant['guardian_name'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_street" name="permanent_street" 
                    value="{{ $applicant['permanent_street'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_city_town_village" name="permanent_city_town_village" 
                    value="{{ $applicant['permanent_city_town_village'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="permanent_post_office" name="permanent_post_office" 
                    value="{{ $applicant['permanent_post_office'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="permanent_pincode" name="permanent_pincode" 
                    value="{{ $applicant['permanent_pincode'] ?? '' }}" maxlength="6">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_street" name="present_street" 
                    value="{{ $applicant['present_street'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_city_town_village" name="present_city_town_village" 
                    value="{{ $applicant['present_city_town_village'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="present_post_office" name="present_post_office" 
                    value="{{ $applicant['present_post_office'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="present_pincode" name="present_pincode" 
                    value="{{ $applicant['present_pincode'] ?? '' }}" maxlength="6">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="mobile" name="mobile" 
                    value="{{ $applicant['mobile_no'] ?? '' }}" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="email" name="email" 
                    value="{{ $applicant['email'] ?? '' }}" oninput="this.value=this.value.toLowerCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="dob" name="dob" 
                    value="{{ $dob }}" required readonly autocomplete="off" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="hrms_id" name="hrms_id" 
                    value="{{ $applicant['hrms_id'] ?? '' }}" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_designation" name="app_designation" 
                    value="{{ $applicant['applicant_designation'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_posting_place" name="app_posting_place" 
                    value="{{ $applicant['applicant_posting_place'] ?? 'NA' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="pay_in" name="pay_in" 
                    value="{{ $applicant['pay_in_the_pay_band'] ?? '' }}" required>
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="app_headquarter" name="app_headquarter" 
                    value="{{ $applicant['applicant_headquarter'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="doj" name="doj" 
                    value="{{ $doj }}" readonly autocomplete="off" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="dor" name="dor" 
                    value="{{ $dor }}" required readonly autocomplete="off" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_name" name="office_name" 
                    value="{{ $applicant['office_name'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_street" name="office_street" 
                    value="{{ $applicant['office_street'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_city" name="office_city" 
                    value="{{ $applicant['office_city_town_village'] ?? '' }}" required oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control" id="office_post_office" name="office_post_office" 
                    value="{{ $applicant['office_post_office'] ?? '' }}" oninput="this.value=this.value.toUpperCase()">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="office_pincode" name="office_pincode" 
                    value="{{ $applicant['office_pin_code'] ?? '' }}" required maxlength="6">
        ...
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="office_phone_no" name="office_phone_no" 
                    value="{{ $applicant['office_phone_no'] ?? '' }}" maxlength="15">
        ...
        <div class="col-md-6" id="replace_rhe_flat_type">
            <div class="form-floating">
                <input type="text" class="form-control" id="rhe_flat_type" name="rhe_flat_type" 
                    value="{{ $applicant['rhe_flat_type'] ?? '' }}" required readonly>
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="doa" name="doa" 
                    value="{{ $doa }}" required readonly autocomplete="off" maxlength="10">
        ...
        <div class="col-md-4" id="computr_serial_no">
            <div class="form-floating">
                <input type="text" class="form-control numeric_positive" id="computer_serial_no" name="computer_serial_no" 
                    value="{{ $applicant['computer_serial_no'] ?? '' }}" required readonly>
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control" id="physical_application_no" name="physical_application_no" 
                    value="{{ $applicant['physical_application_no'] ?? '' }}" required>
        ...
        <div class="col-md-12">
            <div class="form-floating">
                <textarea class="form-control" id="remarks" name="remarks" 
                    placeholder="Remarks" style="height: 100px">{{ $applicant['remarks'] ?? '' }}</textarea>
