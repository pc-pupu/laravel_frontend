...
<html lang="en">
    <head>
       ...
       <link rel="stylesheet" href="{{ asset('/themes/dashboard-theme/css/bootstrap-icons.min.css') }}">
       <link rel="stylesheet" href="{{ asset('/themes/dashboard-theme/css/style.css') }}">
       <link rel="stylesheet" href="{{ asset('/themes/dashboard-theme/css/font-awesome.css') }}">
