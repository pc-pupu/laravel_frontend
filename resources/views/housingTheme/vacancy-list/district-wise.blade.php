...
@section('title', 'RHE Flat Vacancy List (District Wise)')
        ...
        <div class="col-md-12">
            <div class="cms-card">
                <div class="cms-header d-flex justify-content-between align-items-center">
                    <div>
                        <h3><i class="fa fa-building me-2"></i> RHE Flat Vacancy List (District Wise)</h3>
                        <p class="mb-0">View district-wise vacancy list of flats by flat type.</p>
                    </div>
                ...
                <div class="cms-body">
                    <form method="GET" action="{{ url('vacany_list') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-floating mb-3">
                                    <select name="district_id" id="district_id" class="form-select" required>
                                        ...
                                        @foreach($districts as $code => $name)
                                            <option value="{{ $code }}" {{ (int)$selectedDistrictId === (int)$code ? 'selected' : '' }}>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <table class="table table-list table-striped table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-secondary">
                                        <td colspan="5" class="text-end"><strong>Total No. of Vacant Flats:</strong></td>
                            ...
                            <table class="datatable_no_data_found table table-list">
                                ...
                                <tr class="tr_no_data_found">
                                    <td class="td_no_data_found">
                                        @if((int)$selectedDistrictId === 0 || (int)$selectedFlatTypeId === 0)
                                            Please select both District and Flat Type to view vacancy list.
                                        @else
