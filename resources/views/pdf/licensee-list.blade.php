...
<head>
    <meta charset="utf-8">
    <title>{{ $typeName }} Licensee List</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div>
            ...
            <strong style="font-size: 14px;">{{ $typeName }} Licensee List</strong>
        </div>
    </div>
    ...
    <table>
        <thead>
            <tr>
                <th width="25%">Licensee Name</th>
                <th width="25%" class="center">Licence No.</th>
